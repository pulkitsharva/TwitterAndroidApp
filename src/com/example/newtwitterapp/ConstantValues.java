...
public class ConstantValues {
    public static String TWITTER_CONSUMER_KEY = "sZlTQypnejE17fjeIL7o2WATU";
    public static String TWITTER_CONSUMER_SECRET = "PwPKsDHwCxjyk4SywARDdDY2Q6EHVyjVnvJKoBysbczvmtOsbC";
    public static String TWITTER_CALLBACK_URL = "oauth://twitter4j";
